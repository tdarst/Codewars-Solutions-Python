...
Create an empty list "l". For each element of "data", if the age is 55 or higher and the handicap is greater than 7, append senior to l for that index,
otherwise append open.
